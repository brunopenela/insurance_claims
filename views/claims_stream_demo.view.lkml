# The name of this view in Looker is "Claims Stream Demo"
view: claims_stream_demo {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `insurance_claims_demo.claims_stream_demo`
    ;;
  ...
  dimension: fraud_reported_prob {
    type: number
    sql: ${TABLE}.fraud_reported_prob ;;
  }
